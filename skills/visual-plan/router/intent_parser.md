...
**Purpose**: Detailed classification rules for the visual-plan master router.
...
visual-plan should trigger only when the user wants a visual artifact, figure plan,
