# Visual System — visual-plan

This file defines the shared visual language for ALL visual-plan outputs.
...
Every visual-plan output should have a recognizable editorial composition:
...
visual-plan does not use one fixed color scheme for every project. Select a palette
